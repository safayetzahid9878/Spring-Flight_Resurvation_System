...
<html class="no-js"  lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/icon" href="/resources/home/logo/favicon.png"/>
        ...
        <link rel="stylesheet" href="/resources/home/css/hover-min.css">

      
        <link rel="stylesheet"  href="/resources/home/css/datepicker.css" >

        <!--owl.carousel.css-->
        <link rel="stylesheet" href="/resources/home/css/owl.carousel.min.css">
        <link rel="stylesheet" href="/resources/home/css/owl.theme.default.min.css"/>
    ...
    <body>
                            ...
                            <div class="main-menu">
                                ...
                                <div class="collapse navbar-collapse">		  
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="smooth-menu"><a href="#booknow">home</a></li>
                                        <li class="smooth-menu"><a href="#gallery">Destination</a></li>
                                        <li class="smooth-menu"><a href="#pack">Packages </a></li>
                                        <li class="smooth-menu"><a href="#spo">Special Offers</a></li>
                                        <li>
                                           <a href="/client/clientIn">Cancel Reservation</a>
                                        </li>
                                         
                                        <li>
                                            <a href="/login/login1"><button class="book-btn">Admin</button></a>
        ...
        <!--travel-box start-->
        <section id="booknow" class="travel-box">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                                                    ...
                                                    <div class="single-tab-select-box">
                                                        ...
                                                        <div class="travel-select-icon">
                                                            <select class="form-control ">
                                                                ...
                                                                <c:forEach var="f" items="${map.tList}">
                                                                    <option>${f.source}</option>
                                                                </c:forEach>
                                                            </select><!-- /.select-->
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="single-tab-select-box">
                                                        ...
                                                        <div class="travel-select-icon">
                                                            <select class="form-control" name="source" id="sourceVal">
                                                                <c:forEach var="f" items="${map.tList}">
                                                ...
                                                <div class="col-lg-4 col-md-3 col-sm-4">
                                                      ...
                                                      <div class="single-tab-select-box">
                                                        ...
                                                        <div class="travel-select-icon">
                                                            <select class="form-control" name="departure" id="departureVal">

                                                                <c:forEach var="f" items="${map.tList}">
                                                                    <option value="${f.departure}">${f.departure}</option>
                                                                </c:forEach>
...
<!--                                                    <div class="single-tab-select-box">
                                                ...
                                                <form action="/search" method="POST">
                                                    ...
                                                    <div class="clo-sm-5">
                                                        <div class="about-btn pull-right">
                                                            <a href="/search/${f.source}/${f.departure}"><button  class="about-view travel-btn">
                                                                    search	
                                                                </button>
                                                            </a>
                                                        </div>
            ...
            <div class="container">
                ...
                <div class="service-counter text-center">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="single-service-box">
                            <div class="service-img">
                                <img src="/resources/home/images/service/s1.png" alt="service-icon" />
                            </div><!--/.service-img-->
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="single-service-box">
                            <div class="service-img">
                                <img src="/resources/home/images/service/s2.png" alt="service-icon" />
                            </div><!--/.service-img-->
                            <div class="service-content">
                                <h2>
                                    <a href="#">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="single-service-box">
                            <div class="statistics-img">
                                <img src="/resources/home/images/service/s3.png" alt="service-icon" />
                            </div><!--/.service-img-->
                            <div class="service-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="filtr-item">
                                            <img src="/resources/home/images/gallary/g1.jpg" alt="portfolio image"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="filtr-item">
                                            <img src="/resources/home/images/gallary/g2.jpg" alt="portfolio image"/>
                                            <div class="item-title">
                                                <a href="#">
                                                    venuzuala
                                                </a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="filtr-item">
                                            <img src="/resources/home/images/gallary/g3.jpg" alt="portfolio image"/>
                                            <div class="item-title">
                                                <a href="#">
                                                    brazil
                                                </a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="filtr-item">
                                            <img src="/resources/home/images/gallary/g4.jpg" alt="portfolio image"/>
                                            <div class="item-title">
                                                <a href="#">
                                                    australia 
                                                </a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="filtr-item">
                                            <img src="/resources/home/images/gallary/g5.jpg" alt="portfolio image"/>
                                            <div class="item-title">
                                                <a href="#">
                                                    netharlands
                                                </a>
                                    ...
                                    <div class="col-md-8">
                                        <div class="filtr-item">
                                            <img src="/resources/home/images/gallary/g6.jpg" alt="portfolio image"/>
                                            <div class="item-title">
                                                <a href="#">
                                                    turkey
                                                </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="/resources/home/images/packages/p1.jpg" alt="package-place">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="/resources/home/images/packages/p2.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="/resources/home/images/packages/p3.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="/resources/home/images/packages/p4.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="/resources/home/images/packages/p5.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="/resources/home/images/packages/p6.jpg" alt="package-place">
                                <div class="single-package-item-txt">
            ...
            <div class="container">
                ...
                <div class="owl-carousel owl-theme" id="testemonial-carousel">
                    ...
                    <div class="home1-testm item">
                        <div class="home1-testm-single text-center">
                            <div class="home1-testm-img">
                                <img src="/resources/home/images/client/testimonial1.jpg" alt="img"/>
                            </div><!--/.home1-testm-img-->
                    ...
                    <div class="home1-testm item">
                        <div class="home1-testm-single text-center">
                            <div class="home1-testm-img">
                                <img src="/resources/home/images/client/testimonial2.jpg" alt="img"/>
                            </div><!--/.home1-testm-img-->
                            <div class="home1-testm-txt">
                                <span class="icon section-icon">
                                    <i class="fa fa-quote-left" aria-hidden="true"></i>
                        ...
                        <div class="col-sm-4">
                            <div class="single-special-offer">
                                <div class="single-special-offer-bg">
                                    <img src="/resources/home/images/offer/offer-shape.png" alt="offer-shape">
        ...
        <script src="/resources/home/js/jquery.filterizr.min.js"></script>
        ...
        <!--datepicker.js-->
        <script  src="/resources/home/js/datepicker.js"></script>
        ...
        $("#sourceVal").on("change", function () {
            $("#fromVal").val(this.value);
            console.log(this.value)
        })
        
          $("#departureVal").on("change", function () {
