                ...
                <div class="col-md-8">
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row register-center" >
                            <form action="/invoice/view">
                                <h3 class="text-center">OTP is sent to your mobile number</h3><br>
                                <div class="row">

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" name="otp" class="form-control" placeholder="Generate Your OTP *" value="" />
                                        </div>
