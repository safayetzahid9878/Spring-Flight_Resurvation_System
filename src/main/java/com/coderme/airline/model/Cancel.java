...
public class Cancel {
    ...
    public String toString() {
        return "Cancel{" + "id=" + id + ", airpalne=" + airpalne + ", source=" + source + ", departure=" + departure + ", f_date=" + f_date + ", arrival_time=" + arrival_time + ", departure_time=" + departure_time + ", class_name=" + class_name + ", first_name=" + first_name + ", last_name=" + last_name + ", NID=" + NID + ", passport_id=" + passport_id + ", gender=" + gender + ", contact=" + contact + ", email=" + email + ", flight_charge=" + flight_charge + ", discount=" + discount + ", totalFlightCharge=" + totalFlightCharge + ", grandTotal=" + grandTotal + ", totalSeat=" + totalSeat + ", seatNo=" + seatNo + ", flight_name=" + flight_name + ", airline=" + airline + ", status=" + status + '}';
    }
